...
using TaskerFullStackApp.Components;
using TaskerFullStackApp.Components.Account;
...
app.MapRazorComponents<App>()
    ...
    .AddAdditionalAssemblies(typeof(TaskerFullStackApp.Client._Imports).Assembly);
